"""Gibbs-style walk orchestration across model and likelihood samplers."""
...
class Walker:
    ...
    def log_likelihood(self, model_params, likelihood_params):
        """Return log-likelihood for the provided model and likelihood parameters."""

        return self.evidence.log_likelihood(model_params, likelihood_params)

    def log_posterior(self, model_params, likelihood_params):
        """Return log-posterior for the provided model and likelihood parameters."""
